...
Use British English in all prose: code comments, documentation (`README.md`, `CLAUDE.md`, ADRs, `MIGRATION_FROM_PROTOMOLECULE.md`), changeset bodies, commit messages, PR titles/descriptions, and user-facing strings.
